                    ...
                    <div class="products-item-details">
                        ...
                        <div class="products-item-extra">
                            <div class="products-item-info">
                                <div class="products-item-price">400 ₽</div>
            ...
            <div class="order-block">
                <div class="order-form">
                    ...
                    <div class="order-form-inputs">
                        ...
                        <input name="cookie" type="text" placeholder="Выберите печенье">
                        <input name="client" type="text" placeholder="Ваше имя">
                        <input name="numberPhone" type="text" placeholder="Ваш телефон">
                        <button class="button violet-button">Оформить заказ</button>
                        </form>
                    </div> Количество текущих заявок: <span id="requests_counter"></span>
                </div>
